...
import com.example.android.shushme.provider.PlaceDbHelper;
...
public class MainActivity extends AppCompatActivity implements
    ...
    public void onAddPlaceButtonClicked(View view) {
        ...
        }catch (GooglePlayServicesRepairableException se){
            se.getStackTrace();
            Log.e(TAG, se.getMessage());
        }catch(GooglePlayServicesNotAvailableException nse){
            nse.getStackTrace();
