...
public class MainActivity extends AppCompatActivity implements
    ...
    public void refreshPlacesData() {
        Cursor cursor = getContentResolver().query(
                ...
                new String[]{PlaceContract.PlaceEntry.COLUMN_PLACE_ID},
                null,
                null,
                null);
        ...
        while (cursor.moveToNext()) {
            places.add(cursor.getString(cursor.getColumnIndex(PlaceContract.PlaceEntry.COLUMN_PLACE_ID)));
        }
        PendingResult<PlaceBuffer> placeResult = Places.GeoDataApi.getPlaceById(mClient, places.toArray(new String[places.size()]));
